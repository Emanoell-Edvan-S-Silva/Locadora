...
<br>
	<div class="container-xxl">
		<table class="table table-striped table-hover">
			<thead>
        <th><h5>Livros</h5></th>
        <th><a href="../cadastros/cadastro-livro.php"><button type="button" href="#" class="btn btn-primary" style=" border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,.5); ">Novo +</button></a></th>
        <th></th>
        <th></th>
        <th></th>
        ...
        <tr class="table-dark">
          ...
          <th>Total de Alugados</th>
			...
			<tbody>
				<tr><?php include_once '../consultas/consulta-livro.php' ?></tr>
			</tbody>
