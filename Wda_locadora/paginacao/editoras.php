  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" style="margin-left: 20% ;" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" id="barra" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item" style="margin-left: 10% ;">
          <a class="nav-link active" href="editoras.php">Editoras</a>
        </li>
        <li class="nav-item" style="margin-left: 10% ;">
...
<br>
	<div class="container-sm">
		<table class="table table-striped table-hover">
			<thead>
      <th><h5>Editora</h5></th>
        <th><a href="../cadastros/cadastro-editora.php"><button type="button" href="#" class="btn btn-primary" style=" border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,.5); ">Novo +</button></a></th>
        <th>      
            <form  action="">
              <th>
        ...
        <tr class="table-dark">
          ...
          <th >Site</th>
			...
			<tbody>
				<tr><?php include_once '../consultas/consulta-editora.php' ?></tr>
			</tbody>
