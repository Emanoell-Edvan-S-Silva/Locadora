	...
	<?php
		...
		while($dados = $sql_query->fetch_assoc()) {
			...
			<tr>
				...
				<td><a href='../edicao/editar-editora.php?id=<?php echo $dados['id']; ?>' class='btn'><img src='../imagens/editar.png'></a>
				<a href='../confirma/con-delete-edi.php?id=<?php echo $dados['id']; ?>'><img src='../imagens/deletar.png'></a>
			</tr>
			<tr></tr>
			<?php
		}
