	...
	<?php
		...
		while($dados = $sql_query->fetch_assoc()) {
			...
			<tr>
				...
				<td class="text-center"><?php echo $dados['data_alug']; ?></td>
				<td class="text-center"><?php echo $dados['data_devo']; ?></td>

				<td><a href='../confirma/con-baixa-atraso.php?id=<?php echo $dados['id']; ?>' class='btn'><img src='../imagens/entregue2.png'></a></td>
			</tr>
			<?php
		}
	}
