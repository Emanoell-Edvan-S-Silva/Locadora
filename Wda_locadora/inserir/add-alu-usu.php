    ...
    if($data>$prazo_max){
       ...
       javascript:window.location='../cadastros/cadastro-aluguel.php';</script>";
        ...
        if( @$livro_qtd > 0 ){
            ...
            $sql = "INSERT INTO aluguel (id_cliente, nome_cliente, id_livro, nome_livro, autor_livro, editora_livro, data_alu, data_devo) VALUES ('$id_usu','$nome_usu','$id_livro','$nome_li','$autor_li','$editora_li','$data_alug','$data')";
