...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/05/2023 às 23:39
...
(1, 'Imperador das Trevas', 'Ashley darwin', 'Paella', '2021-03-03', 96, 4, 5),
(3, 'A grande Princesa', 'Ashley darwin', 'Mother', '2022-10-03', 49, 1, 2),
(4, 'Em Busca do Tempo Perdido', 'Marcel Proust', 'Record', '2019-06-07', 79, 1, 1),
(5, 'Ao farol', 'Virginia Woolf', 'Rocco', '2001-06-07', 89, 1, 1),
(6, 'Moby Dick', 'Herman Melville', 'Suma', '1851-07-19', 20, 0, 0),
(7, 'A Divina Comédia', 'Dante Alighieri', 'Mother', '1304-09-01', 10, 0, 0),
(8, 'Dom Quixote', 'Dom Quixote de La Mancha', 'Record', '1605-09-07', 59, 1, 1),
...
(12, 'teste5', 'edvan', 'Mother', '2023-05-24', 1, 0, 0),
(13, 'teste6', 'edvan', 'Record', '2023-05-24', 1, 0, 0);
