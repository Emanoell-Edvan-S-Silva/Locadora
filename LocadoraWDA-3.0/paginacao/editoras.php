...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" style="margin-left: 15% ;" id="navbarScroll">
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" id="barra" style="--bs-scroll-height: 100px;">
          ...
          <li class="nav-item" style="margin-left: 10%; white-space: nowrap;font-weight: bold">
            <a class="nav-link active" href="editoras.php"><i class='bx bxs-building-house'></i>Editoras</a>
          </li>
          <li class="nav-item" style="margin-left: 10%; white-space: nowrap;font-weight: bold">
  ...
  <br>
  <div class="container-sm" id="tabela">
    <h5 style="font-weight: bold;"><i class='bx bxs-building-house'></i>Editoras</h5>
    <table id="tsup">
      <tr>
        <td><a href="../cadastros/cadastro-editora.php" class="btn btn-primary" role="button"
    ...
    <table id="tinf" class="table table-borderless table-hover">
      ...
      <tbody>
        <tr>
          <?php include_once '../consultas/consulta-editora.php' ?>
        </tr>
      </tbody>
    </table>
  </div>
