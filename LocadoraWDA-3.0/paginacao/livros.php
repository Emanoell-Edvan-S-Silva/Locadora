...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" style="margin-left: 15% ;" id="navbarScroll">
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" id="barra" style="--bs-scroll-height: 100px;">
          ...
          <li class="nav-item" style="margin-left: 10%; white-space: nowrap;font-weight: bold">
            <a class="nav-link active" href="livros.php"><i class='bx bxs-book-bookmark'></i>Livros</a>
          </li>
          <li class="nav-item" style="margin-left: 10%; white-space: nowrap;font-weight: bold">
  ...
  <br>
  <div class="container-xxl" id="tabela">
    <h5 style="font-weight: bold;margin-left:1%;"><i class='bx bxs-book-bookmark'></i>Livros</h5>
    <table id="tsup">
      <tr>
        <td><a href="../cadastros/cadastro-livro.php" class="btn btn-primary" role="button"
            style=" border-radius: 20px; box-shadow: 0 2px 5px rgba(0,0,0,.5); ">Novo +</a></td>
        <td></td>
        <td></td>
        <td>
          <form action="">
    ...
    <table id="tinf" class="table table-borderless table-hover">
      <thead>
        <tr class="table-dark" id="cabeca" style="text-align: center;">
          ...
          <th>Estoque</th>
          <th>Alugados Agora</th>
          <th>Total de Alugados</th>
          <th colspan="2">Ações</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <?php include_once '../consultas/consulta-livro.php' ?>
        </tr>
      </tbody>
    </table>
  </div>
